...
<head>
    ...
    <title>App Salones - Salones</title>
</head>
...
<body>
    <header class="headerTop">
        ...
        <div class="rightHeader">
            <button onclick="openModalForm('agregar.php')" class="btnAgregar"><span class="material-symbols-rounded">group_add</span>NUEVO SALON</button>
        </div>
    </header>
